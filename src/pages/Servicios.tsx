...
export default function ServiciosPage() {
  ...
  usePageMeta({
    ...
    description:
      "Alquiler de equipos, financiamiento, asistencia técnica y repuestos. Soluciones completas para el reciclaje industrial.",
  });
    ...
    <SiteLayout>
      <section className="pt-40 pb-16 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <p className="mt-6 text-lg text-primary-foreground/80 max-w-2xl">{t("serv.sub")}</p>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div className="relative">
            <img
              src={rental}
              alt={t("serv.rental.kicker")}
              className="rounded-2xl shadow-elegant aspect-[4/3] object-cover"
            />
          </div>
          <div>
            <span className="text-sm uppercase tracking-widest text-primary font-semibold">
            ...
            <p className="mt-5 text-muted-foreground leading-relaxed">{t("serv.rental.desc")}</p>
      ...
      <section className="py-24 bg-secondary">
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:order-1">
            ...
            <p className="mt-5 text-muted-foreground leading-relaxed">{t("serv.fin.desc")}</p>
            <ul className="mt-8 space-y-3">
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 text-center">
          ...
          <a
            href={whatsappUrl(WHATSAPP_SERVICE_MESSAGE)}
            target="_blank"
